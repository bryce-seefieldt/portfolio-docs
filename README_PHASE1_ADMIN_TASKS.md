...
| **2** | Configure environment variables | 10–15 min | NEXT_PUBLIC_* vars set for preview + production |
...
- [Environment Contract](./portfolio-docs/docs/_meta/env/portfolio-app-env-contract.md) — NEXT_PUBLIC_* requirements
...
2. **NEXT_PUBLIC_* variables are CLIENT-VISIBLE:**
