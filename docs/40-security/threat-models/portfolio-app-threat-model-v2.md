...
- Risk register: [docs/40-security/risk-register.md](../risk-register.md)
- Security policies: [docs/40-security/security-policies.md](../security-policies.md)
- Security hardening guide: [docs/60-projects/portfolio-app/09-security-hardening.md](../../60-projects/portfolio-app/09-security-hardening.md)
- Dependency vulnerability runbook: [docs/50-operations/runbooks/rbk-portfolio-dependency-vulnerability.md](../../50-operations/runbooks/rbk-portfolio-dependency-vulnerability.md)
